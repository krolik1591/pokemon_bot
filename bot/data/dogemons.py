...
DOGEMONS = [
    PokemonBase(
        ...
        hp=150,
        lvl=1,
        url='https://t.me/pokecardsitems/57',
    ...
    PokemonBase(
        name='Pidgei',
        hp=60,
        url='https://t.me/pokecardsitems/56',
        lvl=1,
        type=PokemonType.BASIC,
        spells=[
    ...
    PokemonBase(
        name='Pidgiotto',
        hp=120,
        url='https://t.me/pokecardsitems/55',
        lvl=2,
        type=PokemonType.BASIC,
        spells=[
            Spell('Tackle', 11, False, 50),
    ...
    PokemonBase(
        ...
        hp=50,
        lvl=1,
            url='https://t.me/pokecardsitems/54',
        type=PokemonType.BASIC,
        spells=[
    ...
    PokemonBase(
        name='Jigglimuff',
        hp=50,
        url='https://t.me/pokecardsitems/52',
        lvl=1,
        type=PokemonType.BASIC,
        spells=[
        ...
        name='Miowth',
        hp=70,
        url='https://t.me/pokecardsitems/39',
        lvl=1,
        type=PokemonType.BASIC,
        spells=[
        ...
        name='Taures',
        hp=110,
        url='https://t.me/pokecardsitems/43',
        lvl=1,
        type=PokemonType.BASIC,
        spells=[
        ...
        hp=80,
        lvl=1,
        url='https://t.me/pokecardsitems/24',
        ...
        name='Blastoicey',
        hp=150,
        url='https://t.me/pokecardsitems/23',
        lvl=2,
        type=PokemonType.WATER,
        spells=[
            Spell('Tackle', 11, False, 55),
        ...
        hp=170,
        lvl=2,
        url='https://t.me/pokecardsitems/26',
        type=PokemonType.WATER,
        spells=[
        ...
        hp=80,
        lvl=1,
        url='https://t.me/pokecardsitems/50',
        type=PokemonType.WATER,
        spells=[
        ...
        name='Seahorse',
        hp=50,
        url='https://t.me/pokecardsitems/49',
        lvl=1,
        type=PokemonType.WATER,
        spells=[
            Spell('Bite', 11, False, 25),
        ...
        hp=100,
        lvl=1,
        url='https://t.me/pokecardsitems/37',
        ...
        hp=180,
        lvl=2,
        url='https://t.me/pokecardsitems/36',
        type=PokemonType.ROCK,
        spells=[
        ...
        hp=210,
        lvl=1,
        url='https://t.me/pokecardsitems/30',
        type=PokemonType.ROCK,
        spells=[
        ...
        name='Sudowoodo',
        hp=140,
        url='https://t.me/pokecardsitems/41',
        lvl=1,
        type=PokemonType.ROCK,
        spells=[
        ...
        hp=110,
        lvl=1,
        url='https://t.me/pokecardsitems/40',
        type=PokemonType.ROCK,
        spells=[
        ...
        name='Aerodactile',
        hp=190,
        url='https://t.me/pokecardsitems/32',
        lvl=1,
        type=PokemonType.ROCK,
        spells=[
        ...
        name='Bulbasor',
        hp=90,
        url='https://t.me/pokecardsitems/34',
        lvl=1,
        ...
        name='Venusor',
        hp=150,
        url='https://t.me/pokecardsitems/33',
        lvl=2,
        type=PokemonType.GRASS,
        spells=[
        ...
        name='scither',
        hp=100,
        url='https://t.me/pokecardsitems/31',
        lvl=1,
        type=PokemonType.GRASS,
        spells=[
        ...
        PokemonBase(
        name='Tangila',
        url='https://t.me/pokecardsitems/48',
        hp=80,
        lvl=1,
        type=PokemonType.GRASS,
        spells=[
        ...
        name='exiggutor',
        hp=150,
        url='https://t.me/pokecardsitems/38',
        lvl=2,
        type=PokemonType.GRASS,
        spells=[
        ...
        name='charmandar',
        hp=80,
        url='https://t.me/pokecardsitems/22',
        lvl=1,
        ...
        name='Charizard',
        hp=180,
        url='https://t.me/pokecardsitems/21',
        lvl=2,
        type=PokemonType.FIRE,
        spells=[
        ...
        name='Vulpex',
        hp=70,
        url='https://t.me/pokecardsitems/42',
        lvl=1,
        type=PokemonType.FIRE,
        spells=[
        ...
        name='Arkanine',
        hp=150,
        url='https://t.me/pokecardsitems/35',
        lvl=2,
        type=PokemonType.FIRE,
        spells=[
        ...
        hp=80,
        lvl=1,
        url='https://t.me/pokecardsitems/44',
        type=PokemonType.FIRE,
        spells=[
        ...
        hp=90,
        lvl=1,
        url='https://t.me/pokecardsitems/45',
        type=PokemonType.FIRE,
        spells=[
        ...
        hp=50,
        lvl=2,
        url='https://t.me/pokecardsitems/18',
        type=PokemonType.GHOST,
        spells=[
        ...
        name='Genger',
        hp=60,
        url='https://t.me/pokecardsitems/17',
        lvl=3,
        type=PokemonType.GHOST,
        spells=[
        ...
        hp=70,
        lvl=1,
        url='https://t.me/pokecardsitems/29',
        ...
        hp=60,
        lvl=1,
        url='https://t.me/pokecardsitems/46',
        type=PokemonType.ELECTRIC,
        spells=[
        ...
        name='mewtu',
        hp=200,
        url='https://t.me/pokecardsitems/16',
        lvl=10,
        ...
        name='Moltras',
        hp=190,
        url='https://t.me/pokecardsitems/15',
        lvl=10,
        type=PokemonType.LEGENDARY,
        spells=[
